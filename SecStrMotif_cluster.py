...
if __name__ == "__main__":
    ...
    parser.add_argument("-sec_str", "--secondary_structures", action="store", help = "folder with secondary structure predictions", default="/grupos/Marce/estructural/databases/secondary_structures/")

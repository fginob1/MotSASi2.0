...
if __name__ == "__main__":
    ...
    parser.add_argument("-uniref90", "--uniref90_clusters", action="store", help = "file with UniRef90 clusters for each UniProtID", default="/grupos/Marce/estructural/databases/UniProt/UniRef-HomoSapiens-90.tsv")
    ...
    parser.add_argument("-sp_fasta", "--sp_fasta", action="store", help = "file with all fasta entries in SwissProt", default="/grupos/Marce/estructural/databases/UniProt/uniprot_sprot.fasta.bgz")

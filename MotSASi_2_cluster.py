...
from ClinVarMotif_cluster import ClinVarMotif
from ClinVarMatrix_cluster import get_ClinVarMatrix
from GnomADMotif_cluster import GnomADMotif
from GnomADMatrix_cluster import get_GnomADMatrix
from FoldXMotif_cluster import foldx_process
from ConservationScore_cluster import ConservationScore
from SecStrMotif_cluster import scratch
from GOMotif_cluster import Motif_GO
from MotifRelativePosition_cluster import RelativePosition
from ExpBurMotif_cluster import sasa
...
if __name__ == "__main__":
    ...
    parser.add_argument("-tmp", "--tmp_path", action="store", help = "folder receiving foldx output", default="/grupos/Marce/estructural/motsasi/tmp/")
    parser.add_argument("-rep_pdbs", "--repaired_pdbs", action="store", help = "folder with repaired PDBSs", default="/grupos/Marce/estructural/databases/repaired_pdbs/")
    parser.add_argument("-uniref50", "--uniref50_clusters", action="store", help = "file with UniRef50 clusters for each UniProtID", default="/grupos/Marce/estructural/databases/UniProt/UniRef50_sprot_h.csv")
    parser.add_argument("-sp_h_list", "--sp_h_list", action="store", help = "file with all UniProtIDs in SwissProt", default="/grupos/Marce/estructural/databases/UniProt/uniprot_sprot_h.list")
    parser.add_argument("-sp", "--sp_fasta", action="store", help = "file with all fasta entries in SwissProt", default="/grupos/Marce/estructural/databases/UniProt/uniprot_sprot.fasta.bgz")
    parser.add_argument("-sp_list", "--sp_list", action="store", help = "file with all UniProtIDs in SwissProt", default="/grupos/Marce/estructural/databases/UniProt/uniprot_sprot.list")
    parser.add_argument("-trembl", "--trembl_fasta", action="store", help = "file with all fasta entries in TrEMBL", default="/grupos/Marce/estructural/databases/UniProt/uniprot_trembl.fasta.bgz")
    ...
    parser.add_argument("-sec_est", "--secondary_structure", action="store", help = "folder with secondary structure predictions", default="/grupos/Marce/estructural/databases/secondary_structures/")
    ...
    parser.add_argument("-go", "--go_database", action="store", help = "file with codes for GO Terms", default="/grupos/Marce/estructural/databases/GO/go.obo")
    ...
    parser.add_argument("-scratch", "--scratch_path", action="store", help = "scratch secondary structure predictor path", default="/grupos/Marce/estructural/tools/scratch/SCRATCH-1D_1.3/bin/")
    parser.add_argument("-sp_omim_phen", "--sp_omim_phenotypes", action="store", help = "csv with phenotypes associated to UniProtIDs path", default="/grupos/Marce/estructural/databases/OMIM/phenotype_uniprot.csv")
